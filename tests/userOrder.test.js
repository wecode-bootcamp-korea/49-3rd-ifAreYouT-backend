...
describe("user get order", () => {
  ...
  beforeAll(async () => {
    ...
    await dataSource.query(`INSERT INTO payment_methods (id, method) VALUES (1, 'testmethod')`)
    await dataSource.query(`INSERT INTO stages (name) VALUES ('testname')`)
    await dataSource.query(`INSERT INTO seat_grades (grade, price) VALUES (1, 1)`)
    await dataSource.query(`INSERT INTO categories (category_name) VALUES ('testcategoryname')`)
    await dataSource.query(`INSERT INTO performers (name) VALUES ('testname')`)
    await dataSource.query(`INSERT INTO payments (id, user_id, order_id, method_id, amount, status) VALUES (1, 1, 1, 1, 10.50, 'pending')`)
    ...
    await dataSource.query(`INSERT INTO times (id, event_time, event_day, event_id) VALUES (1, '03', '23-03-23', 1)`)
    await dataSource.query(`INSERT INTO seats (id, row_name, col_name, stage_id, grade_id) VALUES (1, 'test', 123, 1, 1)`)
